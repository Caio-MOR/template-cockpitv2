...
Se algum gate falhar, mostre a saída da falha e diagnostique a causa antes de propor conserto. O verde local é o que o hook `pre-push` exige para liberar o push; o CI de PR repete os mesmos gates como rede.
