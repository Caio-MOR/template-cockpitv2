...
| Portable agent 1 | The harness's cheap mechanical subagent is conditional on model-selection support; fallback is harness default or inline execution with independent verification. | `.claude/rules/delegacao-barata.md:3`; `tests/test_runner_sincronizado.py:76`. | PASS |
